...
export type McpManagedServer = {
  name: string
  stub: boolean          // effective: can_stub AND (in_allowlist OR entry_poolable)
  ...
  entry_poolable: boolean  // some agent entry sets poolable:true (per-spec spelling of the stub)
